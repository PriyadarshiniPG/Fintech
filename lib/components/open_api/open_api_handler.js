const { CommonUtils, Csv, I, LoggerFactory, TestData } = inject();
...
class OpenApi {
  ...
  async validateResponse(actualResponse, expectedResponse, strict = true) {
    ...
    await I.report('Response data fields validated, ignoring keys where the value can be anything');
